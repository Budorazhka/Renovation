 ...
 * - команда куратора — «вешалкой» по обе стороны вертикального стержня
 *   (draw.io, Hanger). У нас все участники — листья, поэтому стопка не
 *   создаёт пересечений линий. В админке по одному с каждой стороны: на
 *   живом стенде три раскрытые команды по четыре в ряд занимали ~2800px и
 *   после «Уместить» становились нечитаемыми; вдвое более узкая команда
 *   важнее, чем её высота — вниз холст прокручивается;
